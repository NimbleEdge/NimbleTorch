...
TORCH_API inline at::Tensor special_bessel_y1(const at::Tensor & self) {
    return at::_ops::special_bessel_y1::call(self);
}

// aten::special_bessel_y1.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & special_bessel_y1_out(at::Tensor & out, const at::Tensor & self) {
    return at::_ops::special_bessel_y1_out::call(self, out);
}

// aten::special_bessel_y1.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & special_bessel_y1_outf(const at::Tensor & self, at::Tensor & out) {
    return at::_ops::special_bessel_y1_out::call(self, out);
}
