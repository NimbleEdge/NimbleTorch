...
TORCH_API void _foreach_mul_out(at::TensorList self, const at::Scalar & scalar, at::TensorList out);
...
TORCH_API void _foreach_mul_out(at::TensorList self, at::TensorList other, at::TensorList out);
...
TORCH_API void _foreach_mul_out(at::TensorList self, at::ArrayRef<at::Scalar> scalars, at::TensorList out);
