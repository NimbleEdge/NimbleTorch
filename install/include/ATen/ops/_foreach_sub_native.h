...
TORCH_API void _foreach_sub_out(at::TensorList self, const at::Scalar & scalar, at::TensorList out);
...
TORCH_API void _foreach_sub_out(at::TensorList self, at::TensorList other, const at::Scalar & alpha, at::TensorList out);
...
TORCH_API void _foreach_sub_out(at::TensorList self, at::ArrayRef<at::Scalar> scalars, at::TensorList out);
