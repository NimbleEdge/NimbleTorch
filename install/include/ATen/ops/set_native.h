...
TORCH_API at::Tensor & set_out(const at::Tensor & self, at::Storage source, at::Tensor & out);
...
TORCH_API at::Tensor & set_out(const at::Tensor & self, at::Storage source, int64_t storage_offset, at::IntArrayRef size, at::IntArrayRef stride, at::Tensor & out);
...
TORCH_API at::Tensor & set_out(const at::Tensor & self, const at::Tensor & source, at::Tensor & out);
