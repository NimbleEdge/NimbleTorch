...
TORCH_API inline at::Tensor special_modified_bessel_k0(const at::Tensor & self) {
    return at::_ops::special_modified_bessel_k0::call(self);
}

// aten::special_modified_bessel_k0.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & special_modified_bessel_k0_out(at::Tensor & out, const at::Tensor & self) {
    return at::_ops::special_modified_bessel_k0_out::call(self, out);
}

// aten::special_modified_bessel_k0.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & special_modified_bessel_k0_outf(const at::Tensor & self, at::Tensor & out) {
    return at::_ops::special_modified_bessel_k0_out::call(self, out);
}
