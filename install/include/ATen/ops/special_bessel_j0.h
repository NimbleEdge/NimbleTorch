...
TORCH_API inline at::Tensor special_bessel_j0(const at::Tensor & self) {
    return at::_ops::special_bessel_j0::call(self);
}

// aten::special_bessel_j0.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & special_bessel_j0_out(at::Tensor & out, const at::Tensor & self) {
    return at::_ops::special_bessel_j0_out::call(self, out);
}

// aten::special_bessel_j0.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & special_bessel_j0_outf(const at::Tensor & self, at::Tensor & out) {
    return at::_ops::special_bessel_j0_out::call(self, out);
}
