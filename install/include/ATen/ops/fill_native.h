...
TORCH_API at::Tensor & fill_out(const at::Tensor & self, const at::Scalar & value, at::Tensor & out);
...
TORCH_API at::Tensor & fill_out(const at::Tensor & self, const at::Tensor & value, at::Tensor & out);
