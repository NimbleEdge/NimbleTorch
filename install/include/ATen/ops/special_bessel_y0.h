...
TORCH_API inline at::Tensor special_bessel_y0(const at::Tensor & self) {
    return at::_ops::special_bessel_y0::call(self);
}

// aten::special_bessel_y0.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & special_bessel_y0_out(at::Tensor & out, const at::Tensor & self) {
    return at::_ops::special_bessel_y0_out::call(self, out);
}

// aten::special_bessel_y0.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & special_bessel_y0_outf(const at::Tensor & self, at::Tensor & out) {
    return at::_ops::special_bessel_y0_out::call(self, out);
}
