...
TORCH_API inline at::Tensor special_bessel_j1(const at::Tensor & self) {
    return at::_ops::special_bessel_j1::call(self);
}

// aten::special_bessel_j1.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & special_bessel_j1_out(at::Tensor & out, const at::Tensor & self) {
    return at::_ops::special_bessel_j1_out::call(self, out);
}

// aten::special_bessel_j1.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & special_bessel_j1_outf(const at::Tensor & self, at::Tensor & out) {
    return at::_ops::special_bessel_j1_out::call(self, out);
}
